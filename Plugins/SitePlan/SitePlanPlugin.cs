...
{
    public class SitePlanPlugin : MissionPlanner.Plugin.Plugin
    {
        ...
        {
            using (var gridui = new SitePlanUI(this))
            {
                ...
                {
                    CustomMessageBox.Show("Terrain following altitude mode cannot be used with the site plan tool.", "Error");
                }
